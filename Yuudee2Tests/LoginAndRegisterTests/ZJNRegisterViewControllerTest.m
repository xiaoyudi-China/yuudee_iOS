//
//  ZJNRegisterViewControllerTest.m
//  Yuudee2Tests
//
...
@interface ZJNRegisterViewControllerTest : XCTestCase

@end

@implementation ZJNRegisterViewControllerTest
...
- (void)testPhoneIsRegister{
    XCTestExpectation *expectation = [self expectationWithDescription:@"..."];
    ZJNRegisterViewController *vc = [[ZJNRegisterViewController alloc]init];
    [vc testPhoneIsRegister:@"13661316354" disId:1 success:^(id json) {
        [expectation fulfill];
