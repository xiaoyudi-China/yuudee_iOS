//
//  ZJNRegisterVerifyCodeViewControllerTest.m
//  Yuudee2Tests
//
...
@interface ZJNRegisterVerifyCodeViewControllerTest : XCTestCase

@end

@implementation ZJNRegisterVerifyCodeViewControllerTest
