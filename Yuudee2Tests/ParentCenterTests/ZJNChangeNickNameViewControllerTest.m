//
//  ZJNChangeNickNameViewControllerTest.m
//  Yuudee2Tests
//
//  Created by Anton on 2019/4/25.
//  Copyright © 2019 北京道口贷科技有限公司. All rights reserved.
//  JOXHMz8v75TKp9D3uXQyAQ==

#import <XCTest/XCTest.h>
#import "ZJNChangeNickNameViewController.h"

@interface ZJNChangeNickNameViewControllerTest : XCTestCase

@end

@implementation ZJNChangeNickNameViewControllerTest
...
- (void)testUpdateChildInfo{
    ...
    [vc testUpdateChildInfo:@"IFHmXHR3VHpOsdb5bZBQ==" userName:@"test" success:^(id json) {
        [expectation fulfill];
