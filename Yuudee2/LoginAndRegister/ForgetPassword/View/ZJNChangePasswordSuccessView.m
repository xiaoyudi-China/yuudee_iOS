//
//  ZJNChangePasswordSuccessView.m
//  Yuudee2
//
...
@interface ZJNChangePasswordSuccessView()
//木纹背景图
...
@end
@implementation ZJNChangePasswordSuccessView
...
-(UIButton *)showBtn{
    if (!_showBtn) {
        ...
        [_showBtn setTitle:@"恭喜您，修改密码成功" forState:UIControlStateNormal];
