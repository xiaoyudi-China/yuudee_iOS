...
- (void)testFunctionWithDayModel:(ZJNDayHistoryModel *)model{
    ...
    NSIndexPath *path01 = [NSIndexPath indexPathForRow:1 inSection:0];
    [self tableView:self.tableView cellForRowAtIndexPath:path01];
    [self tableView:self.tableView heightForRowAtIndexPath:path01];
}
...
- (void)testFunctionWithMonthModel:(ZJNMonthHistoryModel *)model{
    ...
    ZJNStudyHistoryTableViewCell *cell01 = [[ZJNStudyHistoryTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell01"];
    [cell01 testFunction];
